...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-lg font-semibold mb-4">
            @if($prestasi->status_verifikasi == 'rejected')
                Perbaiki Prestasi yang Ditolak
            @else
                Edit Prestasi
            @endif
        </h2>

        @if($prestasi->status_verifikasi == 'rejected' && $prestasi->catatan_verifikasi)
            <div class="bg-red-50 border border-red-200 rounded-md p-4 mb-6">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-red-800">Prestasi Ditolak</h3>
                        <div class="mt-2 text-sm text-red-700">
                            <p><strong>Alasan penolakan:</strong> {{ $prestasi->catatan_verifikasi }}</p>
                            <p class="mt-1">Silakan perbaiki data sesuai catatan di atas dan submit ulang.</p>
                        </div>
                    </div>
                </div>
            </div>
